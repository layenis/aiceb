<?php
	...
	if(isset($_POST['action']))
	{
		...
		$agendasgerais->id = get('id');
		
		if(!empty($agendasgerais->id))
		{
			# pesquisa pelo id
			$agendasgerais = $agendasgeraisController->buscaPorId($agendasgerais->id);
			...
			{
				$agendasgeraisController->excluir($agendasgerais->id);
