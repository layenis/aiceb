<?php
	...
	if(isset($_POST['action']))
	{
		...
		$atasregionais->id = get('id');
		
		if(!empty($atasregionais->id))
		{
			# pesquisa pelo id
			$atasregionais = $atasregionaisController->buscaPorId($atasregionais->id);
			...
			{
				$atasregionaisController->excluir($atasregionais->id);
