<?
	...
	if(isset($_POST['action']))
	{
		if(($id = (int) $_GET['id']) != 0)
		{
			...
			<html>
				<body>
					<center><font color="#000000" size="3"> <b> Detalhes da Ata da Diretoria Geral</b></font></center>
					<table>
						<tr>
							<td><b> Número: </b></td>
			...
			if(mail($email, "Ata da diretoria geral", $mensagem, $headers))
			{
						...
						<form name="" method="post" action="">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabela-vs">
								...
								<tr class="marcador-vs">
									<td colspan="2">Enviar ata da diretoria geral por e-mail</td>
								</tr>
