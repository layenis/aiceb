<?php
	...
	if(isset($_POST['action']))
	{
		...
		$membrosregionais->id = get('id');
		
		if(!empty($membrosregionais->id))
		{
			# pesquisa pelo id
			$membrosregionais = $membrosregionaisController->buscaPorId($membrosregionais->id);
			...
			{
				$membrosregionaisController->excluir($membrosregionais->id);
