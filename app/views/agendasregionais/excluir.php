<?php
	...
	if(isset($_POST['action']))
	{
		...
		$agendasregionais->id = get('id');
		
		if(!empty($agendasregionais->id))
		{
			# pesquisa pelo id
			$agendasregionais = $agendasregionaisController->buscaPorId($agendasregionais->id);
			...
			{
				$agendasregionaisController->excluir($agendasregionais->id);
