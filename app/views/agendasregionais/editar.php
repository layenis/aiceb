<?php
	...
	{
		$agendasregionais->assignIdentifier($_POST['id']);
			
		# recuperar os campos
		$agendasregionais = $agendasregionais->recuperarCampos($agendasregionais, $_POST, 'editar');
		...
		if (count($erro) == 0)
		{
			...
			$agendasregionais->modified_at = date('Y-m-d H:i:s');
